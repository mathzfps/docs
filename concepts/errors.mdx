...
| **500** | Erro interno Paysure | Retente. Persistindo, abra ticket. |
| **501** | Funcionalidade não suportada pela adquirente | — |
...
| `Provedor temporariamente indisponível.` | Saldo zerado no provedor ou erro deles |
| `Falha na validação dos dados.` | Dados rejeitados pela adquirente |
